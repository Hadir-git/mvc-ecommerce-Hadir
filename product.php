...
<head>
  ...
  ?>
  <title>H&H Tech — <?php echo htmlspecialchars($name) ?></title>
</head>
<body>
        ...
        <div class="row">
          <div class="col s4" style="position: relative;">   
            <a class="magnifier-thumb-wrapper demo">
              <img id="thumb" style="width: 100%; max-height: 350px; object-fit: contain; margin-top: 30px; display: block;" 
              src="product_images/<?php echo($image); ?>"
              data-large-img-url="product_images/<?php echo($image); ?>"
              data-large-img-wrapper="preview">
            </a>
            <div class="magnifier-preview example heading" id="preview" style="position: absolute; top: 30px; left: 105%; width: 400px; height: 350px; z-index: 50;"></div>
          </div>
          <div class="col s8">
            <div class="row">
