          ...
          <table class="responsive-table">
            <tbody>
              <?php
                ...
                if ($sumTotal >= 200){
                  $displayShipping = 0;
                  $displaySVoucher = "<span style='color:#e2d4b8 !important;'>(Shipping voucher applied)</span>";
                }
                ...
                if ($displayShipping === 0)
                  $displayShipping = "<span style='color:#e2d4b8 !important; text-decoration:underline;'>RM$displayShipping</span>";
                else
                  $displayShipping = "<span style='color:#e2d4b8 !important;'>RM$displayShipping</span>";

                if ($sumTotal >= 2000){
                  $shippingTotal = $sumTotal - 100;
                  $displayPVoucher = "<span style='color:#e2d4b8 !important; text-decoration:underline;'>-RM100</span> <span style='color:#e2d4b8 !important;'>(Promo voucher applied)</span>";
                }
                else if ($sumTotal >= 200 && $sumTotal < 2000){ 
                  $shippingTotal = $sumTotal;
                  $displayPVoucher = "<span style='color:#e2d4b8 !important;'>None (min spend not reached)</span>";
                }
                else if ($sumTotal < 200){ 
